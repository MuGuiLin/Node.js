...
module.exports.initModel = async (sequelize) => {
  ...
  const Product = sequelize.define('product', {
    ...
    userId: Sequelize.INTEGER  //指定外键名 在定义表关系时用
  }, {
    tableName: 'products' // 指定在数据库中的表名
  });
  ...
  /**
   * 定义表关系 
   * 表关系有：1:1 (1对1)，1:N (1对多)，N:M (多对多)
   */

  // 表关系设置为1对多关系（会添加userId到Product表作为外键）这里是 1:N 的关系 即 User表 和 Product表是一对多的关系
  // 1端建立关系
